        ...
        {loading ? (
          ...
          <div className="space-y-4 p-5 sm:p-6">
            {learningPaths.map((path) => {
              ...
              return <div key={path.enrollment_id} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:-translate-y-0.5 hover:border-primary-200 hover:shadow-md sm:p-6">
